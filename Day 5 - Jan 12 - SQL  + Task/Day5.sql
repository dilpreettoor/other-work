...
INSERT INTO `c1` VALUES (1,'Ashley','Ash','32 Washington street','WDC',321200),(8,'Ashko Charles','AK','Washington D.C.','USA',421044);
...
INSERT INTO `ctest` VALUES (1,'New York',NULL),(2,'Washington D.C.',NULL);
...
INSERT INTO `customers` VALUES (1,'Ashley','Ash','32 Washington street','WDC',321200),(2,'Bob marley','Bm','Keele Street','Toronto',100100),(3,'Cherlies Theron','Cher','329 Empire State Building','New York',120134),(4,'Denial Jack','DJ','Spartan Building. East','Brazil',341020),(5,'Donna newman','New','250 Charlson blvd','Toronto',120130),(6,'Eston M.','M.','21 York. DV.','Toronto',201023),(7,'Bobby Chacko','Chac','Kennedy','New York',320300),(8,'Ashko Charles','AK','Washington D.C.','USA',421044),(9,'Tony Special','Specie','Oakville','GTA',418921),(10,'Jack Sp','Sparrow','Oaster village','New Jersey',102301),(11,'Keshav',NULL,NULL,NULL,NULL);
...
INSERT INTO `persons` VALUES (1,'Bob','Marley',19,2),(2,'Chris','H.',19,2),(3,'Yes','H.',12,2);
...
-- Dump completed on 2018-01-12 10:57:20
